...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  uploaded: { label: 'Uploaded', className: 'bg-success/10 text-success border-success/20' },
  uploading: { label: 'Uploading', className: 'bg-info/10 text-info border-info/20 animate-pulse' },
