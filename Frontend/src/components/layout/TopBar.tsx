        ...
        <div className="flex items-center bg-muted/30 px-2 sm:px-3 lg:px-4 py-1.5 rounded-full border border-border/50 gap-2 sm:gap-3 lg:gap-6">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-[8px] sm:text-[9px] uppercase font-heavy text-muted-foreground tracking-tighter hidden xl:block">Status</span>
              <span className="text-[10px] sm:text-xs font-bold text-foreground whitespace-nowrap">Secure</span>
            </div>
          </div>
